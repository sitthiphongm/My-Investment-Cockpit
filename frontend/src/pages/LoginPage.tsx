...
export default function LoginPage() {
  ...
  useEffect(() => {
    ...
    if (errorParam) {
      const message =
        errorDescription || getErrorMessage(errorParam);
      setError(message);
    }
  ...
  return (
    <div className="login-page">
      <div className="login-container">
        ...
        {pendingApproval && (
          <div className="login-pending" role="status">
            <span className="login-pending-icon">⏳</span>
            <div>
              <strong>Pending Approval</strong>
              <p>
                Your account is awaiting admin approval. You will be able to
                access the application once approved.
              </p>
            </div>
          </div>
        )}
